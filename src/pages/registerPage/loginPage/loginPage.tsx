...
const LoginPage = () => {
  ...
  try {
    ...
    navigate("/");
    alert("Token succesfully! welcome to Home");
  } catch (error) {
    console.error(error);
    alert("Error login");
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h2 className="text-center text-4xl font-bold text-blue-700 mb-2">ДОБРО ПОЖАЛОВАТЬ !</h2>
        <p className="text-center text-lg text-gray-700 mb-10">Войдите в свою учетную запись продавца</p>
