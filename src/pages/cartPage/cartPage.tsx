        ...
        <div className="mt-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 w-full md:w-96 border border-gray-100">
            ...
            <button
              ...
              className="w-full mt-6 py-5 bg-gradient-to-r from-indigo-600 to-blue-600 text-white text-lg font-semibold rounded-xl hover:from-indigo-700 hover:to-blue-700 transition duration-300 shadow-lg"
            >
              Proceed to Checkout
            </button>
          </div>
